...
**Source:** [`@xiaoliyo/pi-tui`](https://github.com/earendil-works/pi-mono/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@xiaoliyo/pi-tui";
...
```typescript
import { Container, type Focusable, Input } from "@xiaoliyo/pi-tui";
...
Import from `@xiaoliyo/pi-tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@xiaoliyo/pi-tui";
```
...
```typescript
import { matchesKey, Key } from "@xiaoliyo/pi-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@xiaoliyo/pi-tui";
...
```typescript
import { getMarkdownTheme } from "@xiaoliyo/pi-coding-agent";
import { Markdown } from "@xiaoliyo/pi-tui";
...
For letting users pick from a list of options. Use `SelectList` from `@xiaoliyo/pi-tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@xiaoliyo/pi-coding-agent";
import { DynamicBorder } from "@xiaoliyo/pi-coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@xiaoliyo/pi-tui";
...
```typescript
import { BorderedLoader } from "@xiaoliyo/pi-coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@xiaoliyo/pi-tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@xiaoliyo/pi-coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@xiaoliyo/pi-tui";
...
import { matchesKey, truncateToWidth } from "@xiaoliyo/pi-tui";
