...
```bash
npm uninstall -g @xiaoliyo/pi-coding-agent
```

For pnpm, Yarn, or Bun installs, use the matching global remove command: `pnpm remove -g @xiaoliyo/pi-coding-agent`, `yarn global remove @xiaoliyo/pi-coding-agent`, or `bun uninstall -g @xiaoliyo/pi-coding-agent`.
