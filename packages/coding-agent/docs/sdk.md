...
```bash
npm install @xiaoliyo/pi-coding-agent
```
...
```typescript
import { createAgentSession, SessionManager } from "@xiaoliyo/pi-coding-agent";
...
The `Agent` class (from `@xiaoliyo/pi-agent-core`) handles the core LLM interaction. Access it via `session.agent`.
...
import { ModelRuntime } from "@xiaoliyo/pi-coding-agent";
...
```typescript
import { InMemoryCredentialStore } from "@xiaoliyo/pi-ai";
import { createAgentSession, ModelRuntime } from "@xiaoliyo/pi-coding-agent";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@xiaoliyo/pi-coding-agent";
...
```typescript
import { createAgentSession } from "@xiaoliyo/pi-coding-agent";
...
import { createAgentSession, defineTool } from "@xiaoliyo/pi-coding-agent";
...
```typescript
import type { InlineExtension } from "@xiaoliyo/pi-coding-agent";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@xiaoliyo/pi-coding-agent";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@xiaoliyo/pi-coding-agent";
