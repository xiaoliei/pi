...
import * as _bundledPiAgentCore from "@xiaoliyo/pi-agent-core";
import type { Provider } from "@xiaoliyo/pi-ai";
import * as _bundledPiAi from "@xiaoliyo/pi-ai";
import type { KeyId } from "@xiaoliyo/pi-tui";
import * as _bundledPiTui from "@xiaoliyo/pi-tui";
...
// avoiding a circular dependency. Extensions can import from @xiaoliyo/pi-coding-agent.
...
const VIRTUAL_MODULES: Record<string, unknown> = {
	...
	"@xiaoliyo/pi-agent-core": _bundledPiAgentCore,
	"@xiaoliyo/pi-tui": _bundledPiTui,
	"@xiaoliyo/pi-ai": _bundledPiAi,
	"@xiaoliyo/pi-coding-agent": _bundledPiCodingAgent,
...
function getAliases(): Record<string, string> {
	...
	const piAgentCoreEntry = resolveWorkspaceOrImport("agent/dist/index.js", "@xiaoliyo/pi-agent-core");
	const piTuiEntry = resolveWorkspaceOrImport("tui/dist/index.js", "@xiaoliyo/pi-tui");
	const piAiEntry = resolveWorkspaceOrImport("ai/dist/index.js", "@xiaoliyo/pi-ai");

	_aliases = {
		"@xiaoliyo/pi-coding-agent": piCodingAgentEntry,
		"@xiaoliyo/pi-agent-core": piAgentCoreEntry,
		"@xiaoliyo/pi-tui": piTuiEntry,
		"@xiaoliyo/pi-ai": piAiEntry,
