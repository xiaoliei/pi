...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `@xiaoliyo/pi-coding-agent` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "@xiaoliyo/pi-coding-agent";
	 *
...
export interface ProviderConfig {
	...
	baseUrl?: string;
	/** API key literal, env interpolation ($ENV_VAR or ${ENV_VAR}), or leading !command. Optional for keyless local servers. */
	apiKey?: string;
