...
${chalk.bold("Examples:")}
  # Add or manage API endpoints (interactive /connect wizard)
  ${APP_NAME}
...
${chalk.bold("Environment Variables:")}
  Endpoint API keys are configured per endpoint in <agentDir>/models.json via
  /connect or manual edits: literal values, $ENV_VAR interpolation, and
  !command execution are supported. No built-in provider env vars remain.
