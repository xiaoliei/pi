...
import type { AssistantMessage, Model } from "@xiaoliyo/pi-ai";
...
vi.mock("@xiaoliyo/pi-ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@xiaoliyo/pi-ai")>();
	return {
		...actual,
