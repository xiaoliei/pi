...
```bash
npm install -g --ignore-scripts @xiaoliyo/pi-coding-agent
```
...
- [@xiaoliyo/pi-ai](https://www.npmjs.com/package/@xiaoliyo/pi-ai): Core LLM toolkit
- [@xiaoliyo/pi-agent-core](https://www.npmjs.com/package/@xiaoliyo/pi-agent-core): Agent framework
- [@xiaoliyo/pi-tui](https://www.npmjs.com/package/@xiaoliyo/pi-tui): Terminal UI components
